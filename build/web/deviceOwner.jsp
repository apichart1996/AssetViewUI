    ...
    <head>
        ...
        <body> 
            ...
            <ul>
                ...
                <li><a class="active" href="deviceOwner.jsp"><i class="fa fa-fw fa-building-o"></i>Device Owner</a></li>
        ...
        <h:form>
            <%--<h:graphicImage value="img/deviceowner.jpg"/>--%>
        <div align="center">
            <h2>Device Owner Detail</h2>
        <table border="1" cellpadding="20">
            ...
            <c:forEach var="equipment" items="${deviceownerBean.equipList}" >
                <tr>
                    <td>${equipment.id}</td>
