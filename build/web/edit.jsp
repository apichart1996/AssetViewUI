        ...
        <h:form>
            ...
            <div align="center">
                ...
                <table border="1" cellpadding="20">
                    Assign to : <h:inputText value="#{editBean.empno}"></h:inputText><br>
                    Type : <h:inputText value="#{editBean.type}"></h:inputText><br>
                    Brand : <h:inputText value="#{editBean.brand}"></h:inputText><br>
                    Model : <h:inputText value="#{editBean.model}"></h:inputText><br>
                    SerialNo : <h:inputText value="#{editBean.serialno}"></h:inputText><br>

                    <br><h:commandButton value="Edit" action="#{editBean.validatEdit()}"></h:commandButton>
