...
<html>
    <f:view>
        ...
        <body>
            <h:graphicImage value="img/Head.jpg" width="1350px" height="120px"/>
            ...
            <h:form>
                <div align="center">
                    <%--<h:graphicImage value="img/welcome.jpg"/>--%>
                    <h:graphicImage value="img/bg.jpg" width="450px" height="350px" style="background: white"/><br>
                    
                     <h:commandButton id="Welcome" value="Welcome" action="index.jsp"/> 
                    <%--<h:commandButton id="Search" value="Search" action="search.jsp"/>--%> 
                    <%--<h:commandButton action="search?faces-redirect=true" value="Search" />--%>
