...
@ManagedBean
@RequestScoped
public class adddeviceadminBean {
    private String empno;
    private String type = "-";
    private String brand = "-";
    private String model = "-";
    private String serialno = "-";
    private String asignto = "Owner";
    ...
    public String validatAdd(){
        ...
        try {
            ...
            System.out.println("adddeviceadminBean in : "+in);
            br = new BufferedReader(new InputStreamReader(in));
            System.out.println("adddeviceadminBean br : "+br);
            line = br.readLine();
            System.out.println("adddeviceadminBean line : "+line);
            while(line != null) {
                if(line != null){
                    System.out.println("adddeviceadminBean Line entered : " + line);
